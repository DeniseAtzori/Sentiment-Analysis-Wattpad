...
fileJson = open("frasiStoria1.json","r")
dicFrasi = json.load(fileJson)
...
def chiamaBert(listaFrasi, nome):
    ...
    for v in listaFrasi.values():
        ...
        # Se la frase è più corta, procedo normalmente
            input_ids = tokenizer.encode(v, add_special_tokens=True)
...
chiamaBert(dicFrasi, "frasiStoria1")
